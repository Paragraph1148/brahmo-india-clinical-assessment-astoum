...
| "Apixaban for AF" _(dangerous in valvular AF)_ | "Warfarin only — DOACs CONTRAINDICATED in rheumatic mitral stenosis"          |
...
> _"If you asked me to add Respiratory Medicine tomorrow:_
>
> 1. _Research Indian Chest Society guidelines (1–2 hrs)_
> 2. _Source inhaler brands + ₹ from 1mg.com (1–2 hrs)_
> 3. _`INSERT` drug rows with `condition_tags = ['respiratory', 'asthma']`_
> 4. _`INSERT` guideline rows with the same tags_
> 5. _`INSERT` interaction pairs for inhaler × cardiac drugs_
>
